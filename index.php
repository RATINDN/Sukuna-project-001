...
<div id="iosInstallModal" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.5); z-index: 1000; justify-content: center; align-items: center;">
  <div  id="ios" style="background: #fff; padding: 20px; border-radius: 10px; width: 90%; max-width: 400px; text-align: center; direction: rtl; font-family: 'Vazirmatn', sans-serif;">
    ...
    <img src="images/ki.jpg" alt="iOS Installation Guide" style="width: 100%; max-width: 300px; margin-bottom: 20px; border-radius: 10px;">
    <button id="closeIosModal" style="background: #4CAF50; color: white; padding: 10px 20px; border: none; border-radius: 5px; cursor: pointer;">بستن</button>
  </div>
</div>
    ...
    <nav id="nav" dir="ltr" style="top: 30px;">
      ...
      <div  class="span" class="closebtn"  onclick="openNav()" id="closebtn"  >
        <svg xmlns="http://www.w3.org/2000/svg" width="80%" height="80%" fill="currentColor" class="arrow" viewBox="0 0 16 16" >
    ...
    <div id="myMenu" onclick="closeNav()">
      <!-- <ul> -->
        <div class="lb"  id="lb1"  onclick="opencar()"><h6 class="li3"  >  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-left"  viewBox="0 0 16 16" style="position: relative; top:5px;">
        ...
        ><h6 class="li4"  > <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-left"  viewBox="0 0 16 16" style="position: relative; top:5px;">
          <path fill-rule="evenodd" d="M11.354 1.646a.5.5 0 0 1 0 .708L5.707 8l5.647 5.646a.5.5 0 0 1-.708.708l-6-6a.5.5 0 0 1 0-.708l6-6a.5.5 0 0 1 .708 0"/>
        </svg>  دانلود اپلیکیشن </h6></div>
    ...
    <div id="overlay">
      ...
      <ul >
         <li style="cursor: pointer; " class="li1"     id="li1" >خودروها <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi-down" id="bi-down" viewBox="0 0 16 16">
          ...
          <div class="veil" id="menu-box" >
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="down2" viewBox="0 0 16 16">
              <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708"/>
            </svg>
          
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="up" viewBox="0 0 16 16" style="display: none;">
              <path fill-rule="evenodd" d="M7.646 4.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1-.708.708L8 5.707l-5.646 5.647a.5.5 0 0 1-.708-.708z"/>
            </svg>
          
            <div class="veil2" id="veil2">
              <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" viewBox="0 0 16 16" class="down">
                <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708"/>
              </svg>
    ...
    <div class="box" data-title="۲۰۱۳ فراری f8 تروبیتو">
      ...
      <a href="" style="width: 100%;"> <div class="child"><h1 style=" font-weight: 400;" >+</h1></div></a>
      </div>
    <div class="box2" style="display: flex; flex-direction: column;  justify-content: space-between;">
      <div class="box-3" ><h4 style="font-weight: 400;" >۲۰۱۳ فراری f8 تروبیتو</h4></div>
      <div class="box3" style="height: 50%;">
        <h6 style="font-weight: 400;" id="h6">قیمت شروع: ۱,۲۰۰,۰۰۰ دلار</h6>
        <h6 style="font-weight: 400;" id="h6">موجودی: ۹۶۸ دستگاه</h6>
      </div>
      ...
      <div class="mode" id="mode"  ><svg  onclick="darkmode()" xmlns="http://www.w3.org/2000/svg" width="35" height="35" id="sun" fill="currentColor" class="sun" style="display: none;" viewBox="0 0 16 16" >
      ...
      <svg onclick="darkmode()" xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" style="color: black;" class="moon" id="moon" viewBox="0 0 16 16" >
      ...
      <div class="bow" id="bow">
        ...
        <?php else: ?>
            <a href="auth.php" class="register" id="register">ثبت نام / ورود </a>
        <?php endif; ?>
...
<div class="search2" >
   <select id="brand-filter-mobile"  class="select"  >
      ...
      <div class="close" id="close">
        <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="arrow-close" viewBox="0 0 16 16">
          <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8"/>
        </svg>
      </div>
    </div>    
    <div class="parent-mobile" id="parent-mobile">
      ...
      <div class="box-mobile" id="boxing1" data-title="آئودی A6 e-tron 2024">
        ...
        <div class="box2-mobile" style="display: flex; flex-direction: column; justify-content: space-between;">
          <div class="box-3-mobile"><h4 style="font-weight: 400; font-size: normal;" class="h4">آئودی A6 e-tron 2024</h4></div>
      ...
      <div class="box-mobile" id="boxing2" data-title="لامبورگینی آونتادور ۲۰۱۱">
        ...
        <div class="box2-mobile" style="display: flex; flex-direction: column; justify-content: space-between;">
          <div class="box-3-mobile"><h4 style="font-weight: 400; font-size: normal;" class="h4">لامبورگینی آونتادور ۲۰۱۱</h4></div>
          <div class="box3-mobile" style="height: 50%;">
      ...
      <div class="box-mobile" id="boxing3" data-title="رولزرویس فانتوم ۲۰۱۷">
        ...
        <div class="box2-mobile" style="display: flex; flex-direction: column; justify-content: space-between;">
          <div class="box-3-mobile"><h4 style="font-weight: 400; font-size: normal;" class="h4">رولزرویس فانتوم ۲۰۱۷</h4></div>
          <div class="box3-mobile" style="height: 50%;">
      ...
      <div class="box-mobile" id="boxing4" data-title="فراری لافراری ۲۰۱۳">
        ...
        <div class="box2-mobile" style="display: flex; flex-direction: column; justify-content: space-between;">
          <div class="box-3-mobile"><h4 style="font-weight: 400; font-size: normal;" class="h4">فراری لافراری ۲۰۱۳</h4></div>
          <div class="box3-mobile" style="height: 50%;">
      ...
      <div class="box-mobile" id="boxing5" data-title="رنج روور ۲۰۲۳">
        ...
        <div class="box2-mobile" style="display: flex; flex-direction: column; justify-content: space-between;">
          <div class="box-3-mobile"><h4 style="font-weight: 400; font-size: normal;" class="h4">رنج روور ۲۰۲۳</h4></div>
          <div class="box3-mobile" style="height: 50%;">
      ...
      <div class="box-mobile" id="boxing6" data-title="مرسدس بنز S-Class 2021">
        ...
        <div class="box2-mobile" style="display: flex; flex-direction: column; justify-content: space-between;">
          <div class="box-3-mobile"><h4 style="font-weight: 400; font-size: normal;" class="h4">مرسدس بنز S-Class 2021</h4></div>
          <div class="box3-mobile" style="height: 50%;">
      ...
      <div class="box-mobile" id="boxing7" data-title="فراری F8 تریبوتو ۲۰۱۴">
        ...
        <div class="box2-mobile" style="display: flex; flex-direction: column; justify-content: space-between;">
          <div class="box-3-mobile"><h4 style="font-weight: 400; font-size: normal;" class="h4">فراری F8 تریبوتو ۲۰۱۴</h4></div>
          <div class="box3-mobile" style="height: 50%;">
...
<div class="container1">
  ...
  <div class="child2" >
    ...
    <h1 style="font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; font-variant: small-caps; color: white;"  class="move detail">آئودی A6 e-tron 2024 مدل جدید ما</h1> <br>
    ...
    <div class="swiper mySwiper">
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide" style="background-image: url(images/car-1.webp);">
          ...
          <div class="ord">
            <button class="order">سفارش</button>
            <del style="color: red; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;">۲۰٪ تخفیف</del>
            <div class="card">
              <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" class="bi bi-cart4" viewBox="0 0 16 16">
                <path d="M0 2.5A.5.5 0 0 1 .5 2H2a.5.5 0 0 1 .485.379L2.89 4H14.5a.5.5 0 0 1 .485.621l-1.5 6A.5.5 0 0 1 13 11H4a.5.5 0 0 1-.485-.379L1.61 3H.5a.5.5 0 0 1-.5-.5M3.14 5l.5 2H5V5zM6 5v2h2V5zm3 0v2h2V5zm3 0v2h1.36l.5-2zm1.11 3H12v2h.61zM11 8H9v2h2zM8 8H6v2h2zM5 8H3.89l.5 2H5zm0 5a1 1 0 1 0 0 2 1 1 0 0 0 0-2m-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0m9-1a1 1 0 1 0 0 2 1 1 0 0 0 0-2m-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0"/>
              </svg>
      ...
      <div class="child-foot">
        <div class="child2-foot">
          ...
          <div class="box-foot">
            ...
            <a href="" class="a2"><h5>شرکت</h5></a>
            <a href="" class="a2"><h5>وبلاگ</h5></a>
            <a href="" class="a2"><h5>نوآوری</h5></a>
            <a href="" class="a2"><h5>فرصت‌های شغلی</h5></a>
            <a href="" class="a2"><h5>پایداری</h5></a>
          </div>
  
          <!-- بخش خدمات -->
          <div class="box-foot">
            <h2 class="h33">خدمات</h2>
            <a href="" class="a2"><h5>تماس با ما</h5></a>
            <a href="" class="a2"><h5>فرصت‌های شغلی ما</h5></a>
            <a href="" class="a2"><h5>ضمانت‌ها</h5></a>
            <a href="" class="a2"><h5>تبلیغ محصولات شما</h5></a>
          </div>
  
          <div class="box-foot">
            <h2 class="h33">سیاست‌ها</h2>
            <a href="" class="a2"><h5>مدیریت</h5></a>
            <a href="" class="a2"><h5>حساب کاربری شما</h5></a>
            <a href="" class="a2"><h5>حریم خصوصی و سیاست‌ها</h5></a>
            <a href="" class="a2"><h5>مرجوعی و تعویض</h5></a>
            <a href="" class="a2"><h5>موقعیت‌ها</h5></a>
          </div>
        </div>
      </div>
    </div>
...
<div id="profileSection" class="profile-section">
    <div class="profile-card">
        ...
        <div class="profile-header">
            ...
            <svg id="editUsernameBtn" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
        ...
        <div class="profile-info">
            <div class="info-item">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 12.25c1.24 0 2.25-1.01 2.25-2.25S13.24 7.75 12 7.75 9.75 8.76 9.75 10s1.01 2.25 2.25 2.25zm4.5 4c0-1.5-3-2.25-4.5-2.25s-4.5.75-4.5 2.25v.75h9v-.75zM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"/></svg>
...
<div id="confirmationModal" class="confirmation-modal">
    <div class="confirmation-dialog">
        ...
        <p>آیا از حذف حساب کاربری خود مطمئن هستید؟ این عمل غیرقابل بازگشت است و تمام اطلاعات شما برای همیشه پاک خواهد شد.</p>
